				...
				>
					<Grid item xs={12}>
						...
						<TableContainer>
							<Table>
								...
								<TableBody>
									{this.state.data[0] && this.state.data[0].map((parentChild) => {
											...
											<TableRow key={parentChild.id}>
												...
												{this.state.parent[0] && this.state.parent[0].map((parent) => {
													...
													<Typography align="center">
														{parentChild.parentId === parent.id ? parent.name+","+ parent.surname:''}
												...
												{this.state.child[0] && this.state.child[0].map((child) => {
													return(
													<Typography align="center">
														{parentChild.childId === child.id ? child.name+","+ child.surname:''}
												...
												<TableCell align="center">
													...
													<Button style={{ marginLeft: 10 }}
														...
														onClick={() => {
                                                            ...
                                                            deleteParentChild(parentChild.parentId).then((res) => {
                    ...
                    <Grid item xs={12} style={{ textAlign: "left", marginLeft: 10, marginTop: 30 }}>
						<Button
							...
							color="primary"
							onClick={() =>
								this.props.history.push(`/addParentChild`)
							}
						>
							Dodaj powiązanie
						</Button>
